...
//import
import Resso from "../assets/img/bg-hero.png";
...
const Hero = () => {
  ...
  return (
    <section id="Home" className="container mx-auto flex items-center h-screen lg:bg-bghero bg-cover bg-right-bottom bg-no-repeat">
      <div className="flex">
        <div className="flex flex-col lg:gap-x-[30px] lg:flex-row gap-y-8 lg:gap-y-0  ">
          {/* TEXTO */}
          <div className="flex flex-col lg:w-[900px] lg:bg-grey/50 lg:absolute left-0 top-1/4 lg:border-r-2 lg:border-b-2 lg:border-main rounded-br-xl filter lg:drop-shadow-2xl">
            <div className="flex-1 lg:p-8 lg:ml-64">
              <h1
                data-aos="fade-down"
                data-aos-delay="500"
